...
**Title:** Show HN: Garfield Router -- stop paying frontier prices for tasks a $0 local model handles fine
...
Garfield Router fixes this. Single Go binary, sits between your app and your models, classifies each request, sends it to the cheapest backend that can handle it.
