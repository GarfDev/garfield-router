...
func runInit(args []string) {
	...
	fmt.Println("garfield-router init: detecting local environment")
	fmt.Println()
	...
	if len(backends) == 0 {
		...
		fmt.Println()
		fmt.Println("Then re-run: garfield-router init")
		os.Exit(1)
	}
...
func generateInitConfig(backends []initBackend, port int) string {
	...
	sb.WriteString("# Garfield Router - Auto-generated by 'garfield-router init'\n")
	sb.WriteString("# Edit as needed. Config hot-reloads every 5 seconds.\n")
	sb.WriteString("# Docs: https://github.com/Garfield/garfield-router\n\n")
...
func printGenericInstructions(routerURL string, _ int) {
	...
	fmt.Printf("  garfield-router\n\n")
	fmt.Printf("Point your LLM client at:\n")
	fmt.Printf("  %s/v1/chat/completions\n\n", routerURL)
	fmt.Printf("Dashboard:\n")
	fmt.Printf("  %s\n\n", routerURL)
	fmt.Printf("Tool-specific setup:\n")
	fmt.Printf("  garfield-router init --aider      # Aider\n")
	fmt.Printf("  garfield-router init --continue    # Continue.dev\n")
	fmt.Printf("  garfield-router init --cursor      # Cursor\n")
	fmt.Printf("  garfield-router init --claude       # Claude Code\n")
	fmt.Printf("  garfield-router init --openwebui   # Open WebUI\n")
}
...
func configureClaude() {
	...
	mcpServers["garfield-router"] = map[string]interface{}{
		"command": "garfield-router",
		"args":    []string{"mcp"},
